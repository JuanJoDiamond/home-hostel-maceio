...
export const translations = {
  pt: {
    ...
    aria_lang: "Idioma",
    aria_lang_menu: "Selecionar idioma",
    ...
    footer_tagline: "Sua casa em Maceió.",
    footer_nav_title: "Navegação",
    footer_reservas_title: "Reservas",
    footer_reservas_whatsapp: "Reservar pelo WhatsApp",
    footer_reservas_disponibilidade: "Consultar disponibilidade",
    footer_onde_title: "Onde estamos",
    footer_siga_title: "Siga o Home",
    footer_copyright: "© 2026 Home Hostel Maceió. Todos os direitos reservados.",
    footer_micro: "Feito para quem quer viver Maceió de verdade.",
  },
  es: {
    ...
    aria_lang: "Idioma",
    aria_lang_menu: "Seleccionar idioma",
    nav_sobre: "Nosotros",
    ...
    footer_tagline: "Tu casa en Maceió.",
    footer_nav_title: "Navegación",
    footer_reservas_title: "Reservas",
    footer_reservas_whatsapp: "Reservar por WhatsApp",
    footer_reservas_disponibilidade: "Consultar disponibilidad",
    footer_onde_title: "Dónde estamos",
    footer_siga_title: "Seguí al Home",
    footer_copyright: "© 2026 Home Hostel Maceió. Todos los derechos reservados.",
    footer_micro: "Hecho para quienes quieren vivir Maceió de verdad.",
  },
  en: {
    ...
    aria_lang: "Language",
    aria_lang_menu: "Select language",
    ...
    footer_tagline: "Your home in Maceió.",
    footer_nav_title: "Navigation",
    footer_reservas_title: "Bookings",
    footer_reservas_whatsapp: "Book on WhatsApp",
    footer_reservas_disponibilidade: "Check availability",
    footer_onde_title: "Where we are",
    footer_siga_title: "Follow the Home",
    footer_copyright: "© 2026 Home Hostel Maceió. All rights reserved.",
    footer_micro: "Made for those who want to truly live Maceió.",
  },
};
